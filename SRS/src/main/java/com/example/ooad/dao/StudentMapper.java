...
public interface StudentMapper {
    ...
    @Insert("insert into planofstudy(studentssn,courseNumber) values(#{studentssn},#{courseNumber})")
    List<Course> insertPlan(@Param("studentssn") String studentssn,@Param("courseNumber") String courseNumber);
