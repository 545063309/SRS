...
<div class="x-body">
    <xblock>
        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#addModel"><i class="layui-icon"></i>添加课次</button>
                    ...
                    <div class="modal-body">
                        <form  method="get" action="SectionAdd">
                            ...
                            <div class="modal-footer" style="margin-top: 20px">
                                ...
                                <button type="submit" class="btn btn-primary">添加到课程列表</button>
                            </div>
                        </form>
                    </div>
                </div>
